...
public class PlaySound {
	...
	public void play(ZonePlayer player) {
		...
		GetPositionInfoResponse bellSongInfo = playBellSound(player, volumAdjuster);
	...
	private GetPositionInfoResponse playBellSound(ZonePlayer player, VolumAdjuster volumAdjuster) {
